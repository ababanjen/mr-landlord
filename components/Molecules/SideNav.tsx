...
const SideNav = () => {
  ...
  return (
    <div className="min-h-screen h-auto">
      <nav
        id="sidenav-1"
        className="absolute bg-slate-900  left-0 top-0 z-[1035] h-full w-60 -translate-x-full overflow-hidden  shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
...
export const sidebar = ["dashboard", "general", "units", "users"];
